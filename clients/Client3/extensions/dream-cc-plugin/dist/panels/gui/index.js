...
// @ts-ignore
const GUICreator_1 = require("./GUICreator");
...
module.exports = Editor.Panel.define({
    ...
    ready() {
        ...
        // }
        if (this.$.app) {
            const uiCreator = new GUICreator_1.GUICreator();
            const app = (0, vue_1.createApp)({});
            app.config.compilerOptions.isCustomElement = (tag) => tag.startsWith('ui-');
            app.component('MyCounter', {
                template: (0, fs_extra_1.readFileSync)((0, path_1.join)(__dirname, '../../../static/template/vue/gui.html'), 'utf-8'),
                /**
                 * 启动
                 * @returns
                 */
