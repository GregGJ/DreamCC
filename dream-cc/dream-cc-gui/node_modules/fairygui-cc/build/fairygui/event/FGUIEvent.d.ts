...
export declare class FGUIEvent extends CCEvent {
...
export declare function borrowEvent(type: string, bubbles?: boolean): FGUIEvent;
export declare function returnEvent(evt: FGUIEvent): void;
