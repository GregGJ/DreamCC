...
var AutoSizeType = /* @__PURE__ */ ((AutoSizeType2) => {
...
var VertAlignType = /* @__PURE__ */ ((VertAlignType2) => {
  ...
  return VertAlignType2;
})(VertAlignType || {});
var LoaderFillType = /* @__PURE__ */ ((LoaderFillType2) => {
  ...
  return LoaderFillType2;
})(LoaderFillType || {});
var ListLayoutType = /* @__PURE__ */ ((ListLayoutType2) => {
...
var PackageItemType = /* @__PURE__ */ ((PackageItemType2) => {
...
var ProgressTitleType = /* @__PURE__ */ ((ProgressTitleType2) => {
  ...
  return ProgressTitleType2;
})(ProgressTitleType || {});
var ScrollBarDisplayType = /* @__PURE__ */ ((ScrollBarDisplayType2) => {
...
var FlipType = /* @__PURE__ */ ((FlipType3) => {
  FlipType3[FlipType3["None"] = 0] = "None";
  FlipType3[FlipType3["Horizontal"] = 1] = "Horizontal";
  FlipType3[FlipType3["Vertical"] = 2] = "Vertical";
  FlipType3[FlipType3["Both"] = 3] = "Both";
  return FlipType3;
})(FlipType || {});
var ChildrenRenderOrder = /* @__PURE__ */ ((ChildrenRenderOrder2) => {
  ...
  return ChildrenRenderOrder2;
})(ChildrenRenderOrder || {});
var GroupLayoutType = /* @__PURE__ */ ((GroupLayoutType2) => {
  ...
  return GroupLayoutType2;
})(GroupLayoutType || {});
var PopupDirection = /* @__PURE__ */ ((PopupDirection3) => {
  PopupDirection3[PopupDirection3["Auto"] = 0] = "Auto";
  PopupDirection3[PopupDirection3["Up"] = 1] = "Up";
  PopupDirection3[PopupDirection3["Down"] = 2] = "Down";
  return PopupDirection3;
})(PopupDirection || {});
...
var FillMethod = /* @__PURE__ */ ((FillMethod4) => {
  FillMethod4[FillMethod4["None"] = 0] = "None";
  FillMethod4[FillMethod4["Horizontal"] = 1] = "Horizontal";
  FillMethod4[FillMethod4["Vertical"] = 2] = "Vertical";
  FillMethod4[FillMethod4["Radial90"] = 3] = "Radial90";
  FillMethod4[FillMethod4["Radial180"] = 4] = "Radial180";
  FillMethod4[FillMethod4["Radial360"] = 5] = "Radial360";
  return FillMethod4;
})(FillMethod || {});
var FillOrigin = /* @__PURE__ */ ((FillOrigin4) => {
  FillOrigin4[FillOrigin4["Top"] = 0] = "Top";
  FillOrigin4[FillOrigin4["Bottom"] = 1] = "Bottom";
  FillOrigin4[FillOrigin4["Left"] = 2] = "Left";
  FillOrigin4[FillOrigin4["Right"] = 3] = "Right";
  return FillOrigin4;
})(FillOrigin || {});
var ObjectPropID = /* @__PURE__ */ ((ObjectPropID2) => {
  ...
  return ObjectPropID2;
})(ObjectPropID || {});

// src/fairygui/GObject.ts
import { Vec2 as Vec23, Rect, Component, director as director2, Node as Node4, UITransform, UIOpacity, Vec3 } from "cc";

// src/fairygui/display/BlendMode.ts
...
// src/fairygui/event/FGUIEvent.ts
import { Event as CCEvent, Vec2 } from "cc";
var FGUIEvent = class extends CCEvent {
...
// src/fairygui/tween/EaseType.ts
var EaseType = /* @__PURE__ */ ((EaseType2) => {
...
// src/fairygui/gears/GearBase.ts
var GearBase = class _GearBase {
  dispose() {
...
var GearTweenConfig = class {
  constructor() {
    this.tween = true;
    this.easeType = 5 /* QuadOut */;
    this.duration = 0.3;
    this.delay = 0;
  }
};

// src/fairygui/gears/GearAnimation.ts
var GearAnimation = class extends GearBase {
  init() {
    this._default = {
      playing: this._owner.getProp(4 /* Playing */),
      frame: this._owner.getProp(5 /* Frame */)
    };
    this._storage = {};
  }
  addStatus(pageId, buffer) {
  ...
  apply() {
    ...
    this._owner.setProp(4 /* Playing */, gv.playing);
    this._owner.setProp(5 /* Frame */, gv.frame);
  ...
  updateState() {
    ...
    gv.playing = this._owner.getProp(4 /* Playing */);
    gv.frame = this._owner.getProp(5 /* Frame */);
  }
};

// src/fairygui/gears/GearColor.ts
var GearColor = class extends GearBase {
  init() {
    this._default = {
      color: this._owner.getProp(2 /* Color */),
      strokeColor: this._owner.getProp(3 /* OutlineColor */)
    };
    this._storage = {};
  }
  addStatus(pageId, buffer) {
  ...
  apply() {
    this._owner._gearLocked = true;
    var gv = this._storage[this._controller.selectedPageId] || this._default;
    this._owner.setProp(2 /* Color */, gv.color);
    this._owner.setProp(3 /* OutlineColor */, gv.strokeColor);
    this._owner._gearLocked = false;
  }
  updateState() {
    var gv = this._storage[this._controller.selectedPageId];
    ...
    gv.color = this._owner.getProp(2 /* Color */);
    gv.strokeColor = this._owner.getProp(3 /* OutlineColor */);
  }
};

// src/fairygui/gears/GearDisplay.ts
...
// src/fairygui/gears/GearDisplay2.ts
...
// src/fairygui/gears/GearFontSize.ts
var GearFontSize = class extends GearBase {
  ...
  init() {
    this._default = this._owner.getProp(8 /* FontSize */);
    this._storage = {};
  }
  addStatus(pageId, buffer) {
    if (!pageId)
  ...
  apply() {
    ...
    if (data !== void 0)
      this._owner.setProp(8 /* FontSize */, data);
    else
      this._owner.setProp(8 /* FontSize */, this._default);
    this._owner._gearLocked = false;
  }
  updateState() {
    this._storage[this._controller.selectedPageId] = this._owner.getProp(8 /* FontSize */);
  }
};

// src/fairygui/gears/GearIcon.ts
...
// src/fairygui/tween/TweenManager.ts
import { director, game, macro, Node as Node3 } from "cc";

// src/fairygui/utils/Pool.ts
var Pool = class {
...
// src/fairygui/tween/EaseManager.ts
...
// src/fairygui/tween/GTweener.ts
import { Vec2 as Vec22 } from "cc";

// src/fairygui/tween/TweenValue.ts
...
// src/fairygui/tween/TweenManager.ts
var TweenManager = class _TweenManager {
  static createTween() {
    if (!_root) {
      _root = new Node3("[TweenManager]");
      game.addPersistRootNode(_root);
      director.getScheduler().schedule(_TweenManager.update, _root, 0, macro.REPEAT_FOREVER, 0, false);
    }
...
// src/fairygui/gears/GearLook.ts
...
// src/fairygui/gears/GearSize.ts
...
// src/fairygui/gears/GearText.ts
...
var RelationItem = class {
  ...
  internalAdd(relationType, usePercent) {
    ...
    info.axis = relationType <= 6 /* Right_Right */ || relationType == 14 /* Width */ || relationType >= 16 /* LeftExt_Left */ && relationType <= 19 /* RightExt_Right */ ? 0 : 1;
...
// src/tooltips/TooltipManager.ts
...
var GObject = class _GObject {
  constructor() {
    ...
    this._node.on(Node4.EventType.ANCHOR_CHANGED, this.handleAnchorChanged, this);
  ...
  onTouchMove_0(evt) {
    ...
    if (_GObject.draggingObject == this) {
      ...
      if (this._dragBounds) {
        var rect = Decls.GRoot.inst.localToGlobalRect(
          this._dragBounds.x,
          this._dragBounds.y,
      ...
      s_dragging = true;
      var pt = this.parent.globalToLocal(xx, yy, s_vec22);
...
var GObjectPartner = class extends Component {
  callLater(callback, delay) {
    if (!director2.getScheduler().isScheduled(callback, this))
...
var s_vec22 = new Vec23();
var s_vec3 = new Vec3();
var s_rect = new Rect();
var sGlobalDragStart = new Vec23();
...
var GGroup = class extends GObject {
  ...
  handleLayout() {
    ...
    } else if (this._layout == 2 /* Vertical */) {
      var curY = this.y;
      cnt = this._parent.numChildren;
      for (i = 0; i < cnt; i++) {
        child = this._parent.getChildAt(i);
  ...
  resizeChildren(dw, dh) {
    if (this._layout == 0 /* None */ || (this._updating & 2) != 0 || this._parent == null)
      return;
    this._updating |= 2;
    if (this._boundsChanged) {
      this._boundsChanged = false;
...
// src/fairygui/GGraph.ts
import { Color as Color2, Graphics, misc } from "cc";
var GGraph = class extends GObject {
  constructor() {
    ...
    this._lineSize = 1;
    this._lineColor = new Color2();
    this._fillColor = new Color2(255, 255, 255, 255);
...
// src/fairygui/GImage.ts
import { Sprite as Sprite2 } from "cc";

// src/fairygui/display/Image.ts
import { Sprite, UITransform as UITransform2, Vec2 as Vec25 } from "cc";
var Image2 = class extends Sprite {
  constructor() {
    super();
    this._flip = 0 /* None */;
    this._fillMethod = 0 /* None */;
    this._fillOrigin = 2 /* Left */;
    this._fillAmount = 0;
  }
  get flip() {
    return this._flip;
  ...
  set flip(value) {
    if (this._flip != value) {
      this._flip = value;
      let sx = 1, sy = 1;
      if (this._flip == 1 /* Horizontal */ || this._flip == 3 /* Both */)
        sx = -1;
      if (this._flip == 2 /* Vertical */ || this._flip == 3 /* Both */)
        sy = -1;
      if (sx != 1 || sy != 1) {
        let uiTrans = this.node.getComponent(UITransform2);
  ...
  set fillMethod(value) {
    if (this._fillMethod != value) {
      ...
      if (this._fillMethod != 0) {
        ...
        this.fillCenter = new Vec25(0.5, 0.5);
        this.setupFill();
      } else {
  ...
  setupFill() {
    if (this._fillMethod == 1 /* Horizontal */) {
      this._fillClockwise = this._fillOrigin == 3 /* Right */ || this._fillOrigin == 1 /* Bottom */;
      this.fillStart = this._fillClockwise ? 1 : 0;
    } else if (this._fillMethod == 2 /* Vertical */) {
      this._fillClockwise = this._fillOrigin == 2 /* Left */ || this._fillOrigin == 0 /* Top */;
      this.fillStart = this._fillClockwise ? 1 : 0;
    } else {
...
var GImage = class extends GObject {
  constructor() {
    ...
    this._touchDisabled = true;
    this._content = this._node.addComponent(Image2);
    this._content.sizeMode = Sprite2.SizeMode.CUSTOM;
  ...
  constructFromResource() {
    ...
    if (contentItem.scale9Grid)
      this._content.type = Sprite2.Type.SLICED;
    else if (contentItem.scaleByTile)
      this._content.type = Sprite2.Type.TILED;
...
// src/fairygui/GMovieClip.ts
import { Sprite as Sprite4 } from "cc";

// src/fairygui/display/MovieClip.ts
import { Sprite as Sprite3 } from "cc";
var MovieClip = class extends Image2 {
  constructor() {
    super();
    this.interval = 0;
    this.swing = false;
...
var GMovieClip = class extends GObject {
  constructor() {
    ...
    this._content.sizeMode = Sprite4.SizeMode.CUSTOM;
    this._content.trim = false;
...
// src/fairygui/GRoot.ts
import { director as director5, Color as Color9, Vec2 as Vec212, View as View2, AudioSourceComponent, UITransform as UITransform5 } from "cc";
import { EDITOR } from "cc/env";

// src/fairygui/event/InputProcessor.ts
import { Component as Component2, Vec2 as Vec28, RichText as RichText2, sys, Node as Node6, EventMouse, director as director3, Vec3 as Vec32, game as game2 } from "cc";

// src/fairygui/GRichTextField.ts
import { BitmapFont as BitmapFont3, RichText, SpriteAtlas } from "cc";

// src/fairygui/GTextField.ts
import { BitmapFont as BitmapFont2, Color as Color7, Font as Font2, Label, Node as Node5, Vec2 as Vec27 } from "cc";

// src/fairygui/UIPackage.ts
import { Asset, assetManager, AssetManager as AssetManager2, AudioClip, BitmapFont, BufferAsset, dragonBones, ImageAsset, path, Rect as Rect3, resources as resources2, Size as Size2, sp, SpriteFrame as SpriteFrame3, Texture2D, Vec2 as Vec26 } from "cc";

// src/fairygui/event/HitTest.ts
...
// src/fairygui/UIContentScaler.ts
...
// src/fairygui/TranslationHelper.ts
var TranslationHelper = class _TranslationHelper {
  ...
  static translateComponent(item) {
    ...
    for (i = 0; i < childCount; i++) {
      ...
      if (baseType == 9 /* Component */ && buffer.version >= 2) {
...
// src/fairygui/utils/ByteBuffer.ts
import { Color as Color5 } from "cc";
var ByteBuffer = class _ByteBuffer {
  ...
  readString(len) {
    ...
    if (window["TextDecoder"]) {
      if (!_ByteBuffer.TxtDecoder) {
        _ByteBuffer.TxtDecoder = new TextDecoder("utf-8");
      }
      this._pos += len;
      return _ByteBuffer.TxtDecoder.decode(this._bytes.subarray(pos, pos + len));
    }
  ...
  readColor(hasAlpha) {
    ...
    var b = this.readByte();
    var a = this.readByte();
    return new Color5(r, g, b, hasAlpha ? a : 255);
  }
  readChar() {
...
// src/fairygui/UIPackage.ts
var PathUtils = path;
var UIPackage = class _UIPackage {
  constructor() {
    this._items = [];
    this._itemsById = {};
    this._itemsByName = {};
   ...
   */
  static addPackage(path2) {
    let pkg = _instById[path2];
    if (pkg)
      return pkg;
    let asset = resources2.get(path2, BufferAsset);
    if (!asset)
      throw new Error("Resource '" + path2 + "' not ready");
    const buffer = asset.buffer();
    if (!buffer)
      throw new Error("Missing asset data.");
    pkg = new _UIPackage();
    pkg._bundle = resources2;
    pkg.loadPackage(new ByteBuffer(buffer), path2);
  ...
  static loadPackage(...args) {
    ...
    let onComplete;
    let bundle;
    if (args[0] instanceof AssetManager2.Bundle) {
      bundle = args[0];
      path2 = args[1];
      if (args.length > 3) {
        onProgress = args[2];
    ...
    bundle = bundle || resources2;
    bundle.load(path2, Asset, onProgress, (err, asset) => {
      if (err) {
        if (onComplete != null)
          onComplete(err, null);
        return;
      ...
      for (var i = 0; i < cnt; i++) {
        var pi = pkg._items[i];
        if (pi.type == 4 /* Atlas */ || pi.type == 2 /* Sound */) {
  ...
  loadPackage(buffer, path2) {
    if (buffer.readUint() != 1179080009)
      throw new Error("FairyGUI: old package format found in '" + path2 + "'");
    this._path = path2;
    ...
    var pi;
    let pos = path2.lastIndexOf("/");
    let shortPath = pos == -1 ? "" : path2.substring(0, pos + 1);
    path2 = path2 + "_";
    cnt = buffer.readShort();
    for (i = 0; i < cnt; i++) {
      ...
      switch (pi.type) {
        ...
        case 3 /* Component */: {
          ...
          pi.rawData = buffer.readBuffer();
          Decls2.UIObjectFactory.resolveExtension(pi);
          break;
        }
        case 4 /* Atlas */:
        case 2 /* Sound */:
        case 7 /* Misc */: {
          pi.file = path2 + PathUtils.mainFileName(pi.file);
          break;
        }
        case 9 /* Spine */:
        case 10 /* DragonBones */: {
          pi.file = shortPath + PathUtils.mainFileName(pi.file);
          pi.skeletonAnchor = new Vec26();
    ...
    for (i = 0; i < cnt; i++) {
      ...
      var sprite = { atlas: pi, rect, offset: new Vec26(), originalSize: new Size2(0, 0) };
  ...
  internalCreateObject(item, userClass) {
    var g = Decls2.UIObjectFactory.newObject(item, userClass);
    if (g == null)
      return null;
    constructingDepth.n++;
      ...
      case 0 /* Image */:
        if (!item.decoded) {
          ...
          if (sprite) {
            ...
            if (atlasTexture) {
              let sf = new SpriteFrame3();
              sf.texture = atlasTexture;
              sf.rect = sprite.rect;
              sf.rotated = sprite.rotated;
              sf.offset = new Vec26(sprite.offset.x - (sprite.originalSize.width - sprite.rect.width) / 2, -(sprite.offset.y - (sprite.originalSize.height - sprite.rect.height) / 2));
  ...
  loadMovieClip(item) {
    ...
    for (var i = 0; i < frameCount; i++) {
      ...
      let frame = { rect, addDelay, texture: null };
      ...
      if (spriteId != null && (sprite = this._sprites[spriteId]) != null) {
        ...
        if (atlasTexture) {
          ...
          sf.rect = sprite.rect;
          sf.rotated = sprite.rotated;
          sf.offset = new Vec26(frame.rect.x - (item.width - frame.rect.width) / 2, -(frame.rect.y - (item.height - frame.rect.height) / 2));
          sf.originalSize = new Size2(item.width, item.height);
          frame.texture = sf;
        }
      }
      item.frames[i] = frame;
  ...
  loadFont(item) {
    ...
    let spriteFrame = new SpriteFrame3();
  ...
  loadDragonBones(item) {
    this._bundle.load(item.file, dragonBones.DragonBonesAsset, (err, asset) => {
      ...
      this._bundle.load(atlasFile, dragonBones.DragonBonesAtlasAsset, (err2, asset2) => {
        item.decoded = true;
...
// src/fairygui/utils/ToolSet.ts
import { Color as Color6 } from "cc";
function toGrayedColor(c) {
  let v = c.r * 0.299 + c.g * 0.587 + c.b * 0.114;
  return new Color6(v, v, v, c.a);
}

// src/fairygui/utils/UBBParser.ts
var UBBParser = class {
  constructor() {
    this._readPos = 0;
    this._handlers = {};
...
var GTextField = class extends GObject {
  constructor() {
    ...
    this._touchDisabled = true;
    this._text = "";
    this._color = new Color7(255, 255, 255, 255);
    this.createRenderer();
    this.fontSize = 12;
    this.leading = 3;
    this.singleLine = false;
    this._sizeDirty = false;
    this._node.on(Node5.EventType.SIZE_CHANGED, this.onLabelSizeChanged, this);
  }
  createRenderer() {
  ...
  set shadowOffset(value) {
    if (!this._shadowOffset)
      this._shadowOffset = new Vec27();
    this._shadowOffset.set(value);
    if (!this._label)
      return;
    this._label.shadowOffset = new Vec27(this._shadowOffset.x, -this._shadowOffset.y);
  ...
  assignFontColor(label, value) {
    let font = label.font;
    if (font instanceof BitmapFont2 && !font.fntConfig.canTint)
      value = Color7.WHITE;
    if (this._grayed)
  ...
  updateFontSize() {
    ...
    if (font instanceof BitmapFont2) {
  ...
  markSizeChanged() {
    if (this._underConstruct)
      return;
    if (this._autoSize == 1 /* Both */ || this._autoSize == 2 /* Height */) {
      if (!this._sizeDirty) {
  ...
  handleSizeChanged() {
    if (this._updatingSize)
      return;
    if (this._autoSize == 0 /* None */ || this._autoSize == 3 /* Shrink */) {
      this._uiTrans.setContentSize(this._width, this._height);
    } else if (this._autoSize == 2 /* Height */)
      this._uiTrans.width = this._width;
  }
  ...
  setup_beforeAdd(buffer, beginPos) {
    ...
    if (buffer.readBool()) {
      ...
      this.shadowOffset = new Vec27(f1, f2);
    }
    if (buffer.readBool())
      this._templateVars = {};
  }
...
var GRichTextField = class extends GTextField {
  ...
  updateFontSize() {
    ...
    if (font instanceof BitmapFont3) {
...
var InputProcessor = class extends Component2 {
  ...
  onEnable() {
    let node = this.node;
    node.on(Node6.EventType.TOUCH_START, this.touchBeginHandler, this);
    node.on(Node6.EventType.TOUCH_MOVE, this.touchMoveHandler, this);
    node.on(Node6.EventType.TOUCH_END, this.touchEndHandler, this);
    node.on(Node6.EventType.TOUCH_CANCEL, this.touchCancelHandler, this);
    node.on(Node6.EventType.MOUSE_DOWN, this.mouseDownHandler, this);
    node.on(Node6.EventType.MOUSE_MOVE, this.mouseMoveHandler, this);
    node.on(Node6.EventType.MOUSE_UP, this.mouseUpHandler, this);
    node.on(Node6.EventType.MOUSE_WHEEL, this.mouseWheelHandler, this);
    this._touchListener = this.node.eventProcessor.touchListener;
  }
  onDisable() {
    let node = this.node;
    node.off(Node6.EventType.TOUCH_START, this.touchBeginHandler, this);
    node.off(Node6.EventType.TOUCH_MOVE, this.touchMoveHandler, this);
    node.off(Node6.EventType.TOUCH_END, this.touchEndHandler, this);
    node.off(Node6.EventType.TOUCH_CANCEL, this.touchCancelHandler, this);
    node.off(Node6.EventType.MOUSE_DOWN, this.mouseDownHandler, this);
    node.off(Node6.EventType.MOUSE_MOVE, this.mouseMoveHandler, this);
    node.off(Node6.EventType.MOUSE_UP, this.mouseUpHandler, this);
    node.off(Node6.EventType.MOUSE_WHEEL, this.mouseWheelHandler, this);
  ...
  touchEndHandler(evt) {
    ...
    if (ti.target && ti.target.node) {
      if (ti.target instanceof GRichTextField)
        ti.target.node.getComponent(RichText2)["_onTouchEnded"](evt);
      evt2.unuse();
      evt2.type = FGUIEvent.TOUCH_END;
      evt2.bubbles = true;
      ti.target.node.dispatchEvent(evt2);
  ...
  updateInfo(touchId, pos) {
    const camera = director3.root.batcher2D.getFirstRenderCamera(this.node);
    if (camera) {
      s_vec32.set(pos.x, pos.y);
      camera.screenToWorld(s_vec3_2, s_vec32);
...
var s_vec32 = new Vec32();
var s_vec3_2 = new Vec32();

// src/fairygui/GComponent.ts
import { Mask as Mask2, Vec2 as Vec211, Node as Node8, UITransform as UITransform4 } from "cc";

// src/fairygui/action/ControllerAction.ts
...
// src/fairygui/action/PlayTransitionAction.ts
...
// src/fairygui/action/ChangePageAction.ts
...
// src/fairygui/ScrollPane.ts
import { Component as Component3, director as director4, game as game3, isValid, Mask, math, Node as Node7, Rect as Rect4, screen as screen2, sys as sys2, UITransform as UITransform3, Vec2 as Vec29 } from "cc";
var ScrollPane = class _ScrollPane extends Component3 {
  constructor() {
    super(...arguments);
    this._aniFlag = 0;
  }
  setup(buffer) {
    ...
    this._maskContainer = new Node7("ScrollPane");
    this._maskContainer.layer = UIConfig.defaultUILayer;
    this._maskContainerUITrans = this._maskContainer.addComponent(UITransform3);
    ...
    this._viewSize = new Vec29();
    this._contentSize = new Vec29();
    this._pageSize = new Vec29(1, 1);
    this._overlapSize = new Vec29();
    this._tweenTime = new Vec29();
    this._tweenStart = new Vec29();
    this._tweenDuration = new Vec29();
    this._tweenChange = new Vec29();
    this._velocity = new Vec29();
    this._containerPos = new Vec29();
    this._beginTouchPos = new Vec29();
    this._lastTouchPos = new Vec29();
    this._lastTouchGlobalPos = new Vec29();
    ...
    this._refreshBarAxis = this._scrollType == 2 /* Both */ || this._scrollType == 1 /* Vertical */ ? "y" : "x";
  ...
  lockHeader(size) {
    ...
    if (!this._refreshEventDispatching && cr >= 0) {
      ...
      this._tweenChange.set(Vec29.ZERO);
  ...
  handleControllerChanged(c) {
    if (this._pageController == c) {
      if (this._scrollType == 0 /* Horizontal */)
  ...
  adjustMaskContainer() {
    ...
    if (this._dontClipMargin)
      this._maskContainerUITrans.setAnchorPoint(
        (o.margin.left + o._alignOffset.x) / o.width,
  ...
  handleSizeChanged() {
    ...
    if (this._scrollType == 0 /* Horizontal */ || this._scrollType == 2 /* Both */)
      this._overlapSize.x = Math.ceil(Math.max(0, this._contentSize.x - this._viewSize.x));
    else
      this._overlapSize.x = 0;
    if (this._scrollType == 1 /* Vertical */ || this._scrollType == 2 /* Both */)
    ...
    if (this._refreshBarAxis == "x")
      this._container.setPosition(
        math.clamp(this._container.position.x, -max, this._headerLockedSize),
        -math.clamp(-this._container.position.y, -this._overlapSize.y, 0)
      );
    else
      this._container.setPosition(
        math.clamp(this._container.position.x, -this._overlapSize.x, 0),
  ...
  posChanged(ani) {
    ...
    if (!director4.getScheduler().isScheduled(this.refresh, this))
  ...
  onTouchBegin(evt) {
    ...
    if (this._tweening != 0) {
      ...
      this._dragged = false;
    var pt = this._owner.globalToLocal(evt.pos.x, evt.pos.y, s_vec23);
    ...
    this._velocity.set(Vec29.ZERO);
    ;
    this._velocityScale = 1;
    this._lastMoveTime = game3.totalTime / 1e3;
  }
  onTouchMove(evt) {
  ...
  onTouchEnd(evt) {
    ...
    if (flag) {
      ...
      if (!this._inertiaDisabled) {
        var frameRate = 60;
        var elapsed = (game3.totalTime / 1e3 - this._lastMoveTime) * frameRate - 1;
        if (elapsed > 1) {
          var factor = Math.pow(0.833, elapsed);
          this._velocity.x = this._velocity.x * factor;
          this._velocity.y = this._velocity.y * factor;
  ...
  alignPosition(pos, inertialScrolling) {
    ...
    if (this._pageMode) {
      ...
      var pt = this._owner.getSnappingPosition(-pos.x, -pos.y, s_vec23);
  ...
  updateTargetAndDuration2(pos, axis) {
    ...
    if (pos > 0)
      ...
      var isMobile = sys2.isMobile;
      var v2 = Math.abs(v) * this._velocityScale;
      const winSize = screen2.windowSize;
      if (isMobile)
  ...
  startTween(type) {
    this._tweenTime.set(Vec29.ZERO);
    this._tweening = type;
    this.updateScrollBarVisible();
  }
  killTween() {
      ...
      if (pos < -max || max == 0 && this._footerLockedSize > 0) {
        ...
        if (max > 0)
          ...
          pt[this._refreshBarAxis] = Math.max(
            Math.min(pos + this._viewSize[this._refreshBarAxis], this._viewSize[this._refreshBarAxis] - this._footerLockedSize),
...
var PULL_RATIO = 0.5;
var s_vec23 = new Vec29();
var s_rect2 = new Rect4();
var sEndPos = new Vec29();
var sOldChange = new Vec29();
function easeFunc(t, d) {
  return (t = t / d - 1) * t * t + 1;
}

// src/fairygui/Transition.ts
import { Color as Color8 } from "cc";

// src/fairygui/tween/GPath.ts
import { math as math2, Vec2 as Vec210 } from "cc";

// src/fairygui/tween/GPathPoint.ts
var GPathPoint = class _GPathPoint {
  constructor() {
    this.x = 0;
    this.y = 0;
    this.control1_x = 0;
  ...
  static newPoint(x, y, curveType) {
    ...
    pt.control2_x = 0;
    pt.control2_y = 0;
    pt.curveType = curveType || 0 /* CRSpline */;
    return pt;
  }
...
var GPath = class {
  ...
  create(points) {
    ...
    var splinePoints = [];
    var prev = points[0];
    if (prev.curveType == 0 /* CRSpline */)
      splinePoints.push(new Vec210(prev.x, prev.y));
    for (var i = 1; i < cnt; i++) {
      ...
      if (prev.curveType != 0 /* CRSpline */) {
        ...
        if (prev.curveType == 3 /* Straight */) {
          seg.ptCount = 2;
          this._points.push(new Vec210(prev.x, prev.y));
          this._points.push(new Vec210(current.x, current.y));
        } else if (prev.curveType == 1 /* Bezier */) {
          seg.ptCount = 3;
          this._points.push(new Vec210(prev.x, prev.y));
          this._points.push(new Vec210(current.x, current.y));
          this._points.push(new Vec210(prev.control1_x, prev.control1_y));
        } else if (prev.curveType == 2 /* CubicBezier */) {
          seg.ptCount = 4;
          this._points.push(new Vec210(prev.x, prev.y));
          this._points.push(new Vec210(current.x, current.y));
          this._points.push(new Vec210(prev.control1_x, prev.control1_y));
          this._points.push(new Vec210(prev.control2_x, prev.control2_y));
        }
        seg.length = distance(prev.x, prev.y, current.x, current.y);
        this._fullLength += seg.length;
        this._segments.push(seg);
      }
      if (current.curveType != 0 /* CRSpline */) {
        if (splinePoints.length > 0) {
          splinePoints.push(new Vec210(current.x, current.y));
  ...
  getPointAt(t, result) {
    ...
    if (t == 1) {
      ...
      if (seg.type == 3 /* Straight */) {
        result.x = math2.lerp(this._points[seg.ptStart].x, this._points[seg.ptStart + 1].x, t);
        result.y = math2.lerp(this._points[seg.ptStart].y, this._points[seg.ptStart + 1].y, t);
        return result;
      } else if (seg.type == 1 /* Bezier */ || seg.type == 2 /* CubicBezier */)
  ...
  getAnchorsInSegment(segmentIndex, points) {
    ...
    for (var i = 0; i < seg.ptCount; i++)
      points.push(new Vec210(this._points[seg.ptStart + i].x, this._points[seg.ptStart + i].y));
    return points;
  }
  getPointsInSegment(segmentIndex, t0, t1, points, ts, pointDensity) {
    ...
    var seg = this._segments[segmentIndex];
    if (seg.type == 3 /* Straight */) {
      points.push(new Vec210(
        math2.lerp(this._points[seg.ptStart].x, this._points[seg.ptStart + 1].x, t0),
        math2.lerp(this._points[seg.ptStart].y, this._points[seg.ptStart + 1].y, t0)
      ));
      points.push(new Vec210(
        math2.lerp(this._points[seg.ptStart].x, this._points[seg.ptStart + 1].x, t1),
        math2.lerp(this._points[seg.ptStart].y, this._points[seg.ptStart + 1].y, t1)
      ));
    } else {
      var func;
      if (seg.type == 1 /* Bezier */ || seg.type == 2 /* CubicBezier */)
        func = this.onBezierCurve;
      else
        func = this.onCRSplineCurve;
      points.push(func.call(this, seg.ptStart, seg.ptCount, t0, new Vec210()));
      var SmoothAmount = Math.min(seg.length * pointDensity, 50);
      for (var j = 0; j <= SmoothAmount; j++) {
        var t = j / SmoothAmount;
        if (t > t0 && t < t1) {
          points.push(func.call(this, seg.ptStart, seg.ptCount, t, new Vec210()));
          if (ts)
            ts.push(t);
        }
      }
      points.push(func.call(this, seg.ptStart, seg.ptCount, t1, new Vec210()));
    }
    if (ts)
      ts.push(t1);
    return points;
  ...
  onCRSplineCurve(ptStart, ptCount, t, result) {
    ...
    var adjustedT = t == 1 ? 1 : math2.repeat(t * (ptCount - 4), 1);
...
var Transition = class {
  ...
  _play(onComplete, times, delay, startTime, endTime, reversed) {
    ...
    for (var i = 0; i < cnt; i++) {
      ...
      if (item.target == null) {
        ...
        item.target = null;
      if (item.target && item.type == 10 /* Transition */) {
  ...
  stopItem(item, setToComplete) {
    ...
    if (item.tweener) {
      ...
      item.tweener = null;
      if (item.type == 11 /* Shake */ && !setToComplete) {
  ...
  setPaused(paused) {
    ...
    for (var i = 0; i < cnt; i++) {
      ...
      } else if (item.type == 7 /* Animation */) {
        if (paused) {
          item.value.flag = item.target.getProp(4 /* Playing */);
          item.target.setProp(4 /* Playing */, false);
        } else
          item.target.setProp(4 /* Playing */, item.value.flag);
      }
      if (item.tweener)
    ...
    if (this._timeScale != value) {
      ...
      if (this._playing) {
        ...
        for (var i = 0; i < cnt; i++) {
          ...
          else if (item.type == 10 /* Transition */) {
            if (item.value.trans)
              item.value.trans.timeScale = value;
          } else if (item.type == 7 /* Animation */) {
            if (item.target)
              item.target.setProp(7 /* TimeScale */, value);
          }
        }
      }
    }
  ...
  internalPlay() {
    ...
    if (!this._reversed) {
      for (i = 0; i < cnt; i++) {
        ...
        if (item.target == null)
          continue;
        if (item.type == 7 /* Animation */ && this._startTime != 0 && item.time <= this._startTime) {
  ...
  skipAnimations() {
    ...
    for (var i = 0; i < cnt; i++) {
      item = this._items[i];
      if (item.type != 7 /* Animation */ || item.time > this._startTime)
        continue;
      value = item.value;
      if (value.flag)
        continue;
      target = item.target;
      frame = target.getProp(5 /* Frame */);
      playStartTime = target.getProp(4 /* Playing */) ? 0 : -1;
      playTotalTime = 0;
      for (var j = i; j < cnt; j++) {
        item = this._items[j];
        if (item.type != 7 /* Animation */ || item.target != target || item.time > this._startTime)
          continue;
        value = item.value;
        value.flag = true;
        if (value.frame != -1) {
      ...
      target.setProp(4 /* Playing */, playStartTime >= 0);
      target.setProp(5 /* Frame */, frame);
      if (playTotalTime > 0)
        target.setProp(6 /* DeltaTime */, playTotalTime);
    }
  }
  ...
  onTweenStart(tweener) {
    var item = tweener.target;
    if (item.type == 0 /* XY */ || item.type == 1 /* Size */) {
      var startValue;
      var endValue;
      if (this._reversed) {
        startValue = item.tweenConfig.endValue;
  ...
  applyValue(item) {
    ...
    switch (item.type) {
      ...
      case 13 /* Skew */:
        break;
      case 6 /* Color */:
        let color = item.target.getProp(2 /* Color */);
        if (color instanceof Color8) {
          let i = Math.floor(value.f1);
          color.r = i >> 16 & 255;
          color.g = i >> 8 & 255;
          color.b = i & 255;
          item.target.setProp(2 /* Color */, color);
        }
        break;
      case 7 /* Animation */:
        if (value.frame >= 0)
          item.target.setProp(5 /* Frame */, value.frame);
        item.target.setProp(4 /* Playing */, value.playing);
        item.target.setProp(7 /* TimeScale */, this._timeScale);
        break;
      case 8 /* Visible */:
        ...
        if (buffer.version >= 2) {
          ...
          if (pathLen > 0) {
            ...
            for (var j = 0; j < pathLen; j++) {
              ...
              switch (curveType) {
                case 1 /* Bezier */:
                  pts.push(GPathPoint.newBezierPoint(
                    buffer.readFloat(),
                    buffer.readFloat(),
                    buffer.readFloat(),
                    buffer.readFloat()
                  ...
                  break;
                case 2 /* CubicBezier */:
                  pts.push(GPathPoint.newCubicBezierPoint(
                    buffer.readFloat(),
                    buffer.readFloat(),
                    buffer.readFloat(),
                    buffer.readFloat(),
  ...
  decodeValue(item, buffer, value) {
    switch (item.type) {
      ...
      case 13 /* Skew */:
        ...
        if (buffer.version >= 2 && item.type == 0 /* XY */)
...
// src/fairygui/GComponent.ts
var GComponent = class _GComponent extends GObject {
  constructor() {
    super();
    this._sortingChildCount = 0;
    this._invertedMask = false;
    this._childrenRenderOrder = 0 /* Ascent */;
    this._apexIndex = 0;
    ...
    this._alignOffset = new Vec211();
    this._container = new Node8("Container");
    this._container.layer = UIConfig.defaultUILayer;
    this._containerUITrans = this._container.addComponent(UITransform4);
  ...
  removeChildAt(index, dispose) {
    if (index >= 0 && index < this.numChildren) {
      ...
      if (this._childrenRenderOrder == 2 /* Arch */)
  ...
  getChildByPath(path2, classType) {
    var arr = path2.split(".");
    var cnt = arr.length;
    var gcom = this;
    var obj;
  ...
  _setChildIndex(child, oldIndex, index) {
    ...
    this._children.splice(index, 0, child);
    if (this._childrenRenderOrder == 0 /* Ascent */)
      child.node.setSiblingIndex(index);
    else if (this._childrenRenderOrder == 1 /* Descent */)
  ...
  setMask(value, inverted) {
    if (this._maskContent) {
      this._maskContent.node.off(Node8.EventType.TRANSFORM_CHANGED, this.onMaskContentChanged, this);
      this._maskContent.node.off(Node8.EventType.SIZE_CHANGED, this.onMaskContentChanged, this);
      this._maskContent.node.off(Node8.EventType.ANCHOR_CHANGED, this.onMaskContentChanged, this);
    ...
    if (this._maskContent) {
      if (!(value instanceof GImage) && !(value instanceof GGraph))
        return;
      if (!this._customMask) {
        let maskNode = new Node8("Mask");
        maskNode.layer = UIConfig.defaultUILayer;
        maskNode.addComponent(UITransform4);
        maskNode.parent = this._node;
        if (this._scrollPane)
          this._container.parent.parent = maskNode;
        else
          this._container.parent = maskNode;
        this._customMask = maskNode.addComponent(Mask2);
      }
      value.visible = false;
      value.node.on(Node8.EventType.TRANSFORM_CHANGED, this.onMaskContentChanged, this);
      value.node.on(Node8.EventType.SIZE_CHANGED, this.onMaskContentChanged, this);
      value.node.on(Node8.EventType.ANCHOR_CHANGED, this.onMaskContentChanged, this);
  ...
  onMaskReady() {
    ...
    if (this._maskContent instanceof GImage) {
      this._customMask.type = Mask2.Type.SPRITE_STENCIL;
      ...
      if (this._maskContent.type == 2)
        this._customMask.type = Mask2.Type.GRAPHICS_ELLIPSE;
      else
        this._customMask.type = Mask2.Type.GRAPHICS_RECT;
    }
    this._customMask.inverted = this._invertedMask;
  }
  onMaskContentChanged() {
    let maskNode = this._customMask.node;
    let maskUITrans = maskNode.getComponent(UITransform4);
  ...
  setupOverflow(overflow) {
    if (overflow == 1 /* Hidden */)
      this._rectMask = this._container.addComponent(Mask2);
  ...
  _hitTest(pt, globalPt) {
    if (this._customMask) {
      s_vec24.set(globalPt);
      s_vec24.y = UIContentScaler.rootSize.height - globalPt.y;
      let b = this._customMask.isHit(s_vec24) || false;
      if (!b)
        return null;
    }
    if (this.hitArea) {
      ...
      s_vec24.set(pt);
      s_vec24.x += this._container.position.x;
      s_vec24.y += this._container.position.y;
      let clippingSize = this._containerUITrans.contentSize;
      if (s_vec24.x < 0 || s_vec24.y < 0 || s_vec24.x >= clippingSize.width || s_vec24.y >= clippingSize.height)
        return null;
    }
    if (this._scrollPane) {
  ...
  constructFromResource2(objectPool, poolIndex) {
    ...
    for (i = 0; i < childCount; i++) {
      ...
      if (objectPool)
        ...
        if (pi) {
          child = Decls2.UIObjectFactory.newObject(pi);
          child.constructFromResource();
        } else
          child = Decls2.UIObjectFactory.newObject(type);
      }
    ...
    this.buildNativeDisplayList();
    this.setBoundsChangedFlag();
    if (contentItem.objectType != 9 /* Component */)
...
var s_vec24 = new Vec211();

// src/fairygui/Window.ts
...
// src/fairygui/GRoot.ts
var GRoot = class _GRoot extends GComponent {
  static get inst() {
    if (!_GRoot._inst)
  ...
  static create(root) {
    ...
    if (root) {
      root.addChild(_GRoot._inst.node);
    } else {
      director5.getScene().getChildByName("Canvas").addChild(_GRoot._inst.node);
    }
  ...
  constructor() {
    ...
    this._modalLayer.drawRect(0, Color9.TRANSPARENT, UIConfig.modalLayerColor);
    ...
    View2.instance.on("design-resolution-changed", this.onWinResize, this);
    if (!EDITOR) {
      View2.instance.on("canvas-resize", this._thisOnResized);
      window.addEventListener("orientationchange", this._thisOnResized);
    }
  }
  onDestroy() {
    View2.instance.off("design-resolution-changed", this.onWinResize, this);
    if (!EDITOR) {
      View2.instance.off("canvas-resize", this._thisOnResized);
  ...
  getPopupPosition(popup, target, dir, result) {
    ...
    pos.y += sizeH;
    if ((dir === void 0 || dir === 0 /* Auto */) && pos.y + popup.height > this.height || dir === false || dir === 1 /* Up */) {
  ...
  onWinResize() {
    ...
    let anchorPoint = this.node.getParent().getComponent(UITransform5).anchorPoint;
...
// src/fairygui/GTextInput.ts
import { Color as Color10, EditBox, Overflow, UITransform as UITransform6 } from "cc";
...
var MyEditBox = class extends EditBox {
  _init() {
    super._init();
    this.placeholderLabel.getComponent(UITransform6).setAnchorPoint(0, 1);
    this.textLabel.getComponent(UITransform6).setAnchorPoint(0, 1);
...
// src/fairygui/GLoader.ts
import { Asset as Asset2, assetManager as assetManager2, Color as Color11, ImageAsset as ImageAsset2, isValid as isValid2, Node as Node10, resources as resources3, Sprite as Sprite5, SpriteFrame as SpriteFrame5, Texture2D as Texture2D2, UITransform as UITransform7 } from "cc";

// src/fairygui/GObjectPool.ts
...
// src/fairygui/GLoader.ts
var _GLoader = class _GLoader extends GObject {
  constructor() {
    super();
    this._frame = 0;
    ...
    this._color = new Color11(255, 255, 255, 255);
    this._container = new Node10("Image");
    this._container.layer = UIConfig.defaultUILayer;
    this._containerUITrans = this._container.addComponent(UITransform7);
    this._containerUITrans.setAnchorPoint(0, 1);
    this._node.addChild(this._container);
    this._content = this._container.addComponent(MovieClip);
    this._content.sizeMode = Sprite5.SizeMode.CUSTOM;
    this._content.trim = false;
    this._content.setPlaySettings();
  }
  dispose() {
  ...
  set texture(value) {
    ...
    this._content.type = Sprite5.Type.SIMPLE;
    if (value != null) {
  ...
  loadFromPackage(itemURL) {
    ...
    if (contentItem.type == 0 /* Image */) {
      if (!contentItem.asset) {
        ...
        if (this._content.fillMethod == 0) {
          if (contentItem.scale9Grid)
            this._content.type = Sprite5.Type.SLICED;
          else if (contentItem.scaleByTile)
            this._content.type = Sprite5.Type.TILED;
          else
            this._content.type = Sprite5.Type.SIMPLE;
        } else {
          this._content.type = Sprite5.Type.FILLED;
        }
        this.updateLayout();
      }
    } else if (contentItem.type == 1 /* MovieClip */) {
      this._content.interval = contentItem.interval;
      this._content.swing = contentItem.swing;
      this._content.repeatDelay = contentItem.repeatDelay;
      this._content.frames = contentItem.frames;
      this.updateLayout();
    } else if (contentItem.type == 3 /* Component */) {
  ...
  loadExternal() {
    ...
    let callback = (err, asset) => {
      if (this._url != url || !isValid2(this._node))
        return;
      if (err)
        console.warn(err);
      if (asset instanceof SpriteFrame5)
        this.onExternalLoadSuccess(asset);
      else if (asset instanceof Texture2D2) {
        let sf = new SpriteFrame5();
        sf.texture = asset;
        this.onExternalLoadSuccess(sf);
      } else if (asset instanceof ImageAsset2) {
        let texture = new Texture2D2();
        texture.image = asset;
        let sf = new SpriteFrame5();
        sf.texture = texture;
        this.onExternalLoadSuccess(sf);
    ...
    if (typeof this._url == "string") {
      if (this._url.startsWith("http://") || this._url.startsWith("https://") || this._url.startsWith("/"))
        assetManager2.loadRemote(this._url, callback);
      else if (this._url.startsWith("data:image/")) {
        const img = new Image();
        img.src = this._url;
        img.onload = () => {
          const tex = new Texture2D2();
          tex.reset({
            width: img.width,
            height: img.height
          });
        ...
        let bundle = resources3;
        if (this.bundle && assetManager2.bundles.has(this.bundle)) {
          bundle = assetManager2.getBundle(this.bundle);
        }
        bundle.load(this._url + "/spriteFrame", Asset2, callback);
      }
    } else {
  ...
  updateLayout() {
    ...
    var sx = 1, sy = 1;
    if (this._fill != 0 /* None */) {
      sx = this.width / this.sourceWidth;
      sy = this.height / this.sourceHeight;
      if (sx != 1 || sy != 1) {
        if (this._fill == 2 /* ScaleMatchHeight */)
          sx = sy;
        else if (this._fill == 3 /* ScaleMatchWidth */)
          sy = sx;
        else if (this._fill == 1 /* Scale */) {
          if (sx > sy)
            sx = sy;
          else
            sy = sx;
        } else if (this._fill == 5 /* ScaleNoBorder */) {
          if (sx > sy)
            sy = sx;
          else
            sx = sy;
    ...
    if (this._align == 0 /* Left */)
      nx = 0;
    else if (this._align == 1 /* Center */)
      nx = Math.floor((this._width - cw) / 2);
    else
      nx = this._width - cw;
    if (this._verticalAlign == 0 /* Top */)
      ny = 0;
    else if (this._verticalAlign == 1 /* Middle */)
...
_GLoader._errorSignPool = new GObjectPool();
var GLoader = _GLoader;

// src/fairygui/GLoader3D.ts
import { sp as sp2, dragonBones as dragonBones2, assetManager as assetManager3, Color as Color12, isValid as isValid3, resources as resources4, Node as Node11, UITransform as UITransform8, math as math3 } from "cc";
var GLoader3D = class extends GObject {
  constructor() {
    ...
    this._align = 0 /* Left */;
    this._verticalAlign = 0 /* Top */;
    this._color = new Color12(255, 255, 255, 255);
    this._container = new Node11("Wrapper");
    this._container.layer = UIConfig.defaultUILayer;
    this._container.addComponent(UITransform8).setAnchorPoint(0, 1);
    this._node.addChild(this._container);
  }
  dispose() {
    super.dispose();
  ...
  loadFromPackage(itemURL) {
    ...
    if (this._contentItem) {
      ...
      if (this._autoSize)
        this.setSize(this.sourceWidth, this.sourceHeight);
      if (this._contentItem.type == 9 /* Spine */ || this._contentItem.type == 10 /* DragonBones */)
  ...
  onLoaded(err, item) {
    ...
    if (!this._contentItem.asset)
      return;
    if (this._contentItem.type == 9 /* Spine */)
      this.setSpine(this._contentItem.asset, this._contentItem.skeletonAnchor);
    else if (this._contentItem.type == 10 /* DragonBones */)
  ...
  setSpine(asset, anchor, pma) {
    ...
    this._content = node.addComponent(sp2.Skeleton);
  ...
  setDragonBones(asset, atlasAsset, anchor, pma) {
    ...
    this._container.addChild(node);
    node.setPosition(anchor.x, -anchor.y);
    this._content = node.addComponent(dragonBones2.ArmatureDisplay);
    this._content.premultipliedAlpha = pma;
    this._content.dragonAsset = asset;
    this._content.dragonAtlasAsset = atlasAsset;
    this._content.color = this._color;
    let armatureKey = asset["init"](dragonBones2.CCFactory.getInstance(), atlasAsset["_uuid"]);
  ...
  onChange() {
    ...
    if (this._contentItem.type == 10 /* DragonBones */) {
      this.onChangeDragonBones();
    }
  }
  onChangeSpine() {
    var _a;
    if (!(this._content instanceof sp2.Skeleton))
      return;
    if (this._animationName) {
      ...
      if (this._playing)
        ...
        trackEntry.trackTime = math3.lerp(0, trackEntry.animationEnd - trackEntry.animationStart, this._frame / 100);
      }
    } else
      this._content.clearTrack(0);
    let skin = this._skinName || this._content.skeletonData.getRuntimeData().skins[0].name;
    if (((_a = this._content["_skeleton"].skin) == null ? void 0 : _a.name) != skin)
      this._content.setSkin(skin);
  }
  onChangeDragonBones() {
    if (!(this._content instanceof dragonBones2.ArmatureDisplay))
      return;
    if (this._animationName) {
      if (this._playing)
  ...
  loadExternal() {
    if (this._url.startsWith("http://") || this._url.startsWith("https://") || this._url.startsWith("/"))
      assetManager3.loadRemote(this._url, sp2.SkeletonData, this.onLoaded2.bind(this));
    else
      resources4.load(this._url, sp2.SkeletonData, this.onLoaded2.bind(this));
  }
  onLoaded2(err, asset) {
    if (!this._url || !isValid3(this._node))
      return;
    if (err)
      console.warn(err);
  }
...
// src/fairygui/GLabel.ts
import { Color as Color13 } from "cc";
...
// src/fairygui/GButton.ts
import { Color as Color14, EventMouse as EventMouse2 } from "cc";
var _GButton = class _GButton extends GComponent {
  constructor() {
    super();
  ...
  set selected(val) {
    ...
    if (this._selected != val) {
      ...
      if (this._relatedController && this._parent && !this._parent._buildingDisplayList) {
        ...
        } else if (this._mode == 1 /* Check */ && this._relatedController.selectedPageId == this._relatedPageId)
  ...
  setState(val) {
    ...
    if (this._downEffect == 1) {
      ...
      if (val == _GButton.DOWN || val == _GButton.SELECTED_OVER || val == _GButton.SELECTED_DISABLED) {
        if (!this._downColor)
          this._downColor = new Color14();
        var r = this._downEffectValue * 255;
        this._downColor.r = this._downColor.g = this._downColor.b = r;
        for (var i = 0; i < cnt; i++) {
          var obj = this.getChildAt(i);
          if (!(obj instanceof GTextField))
            obj.setProp(2 /* Color */, this._downColor);
        }
      } else {
        for (var i = 0; i < cnt; i++) {
          var obj = this.getChildAt(i);
          if (!(obj instanceof GTextField))
            obj.setProp(2 /* Color */, Color14.WHITE);
        }
      }
  ...
  onTouchBegin_1(evt) {
    if (evt.button != EventMouse2.BUTTON_LEFT)
      return;
    this._down = true;
    evt.captureTouch();
    if (this._mode == 0 /* Common */) {
...
_GButton.DOWN = "down";
_GButton.OVER = "over";
_GButton.SELECTED_OVER = "selectedOver";
_GButton.DISABLED = "disabled";
_GButton.SELECTED_DISABLED = "selectedDisabled";
var GButton = _GButton;

// src/fairygui/GComboBox.ts
import { Color as Color15, EventMouse as EventMouse3 } from "cc";

// src/fairygui/GList.ts
import { Rect as Rect5, Size as Size4, Vec2 as Vec215 } from "cc";
var GList = class extends GComponent {
  ...
  handleArrowKey(dir) {
    ...
    switch (dir) {
      case 1:
        ...
        } else if (this._layout == 2 /* FlowHorizontal */ || this._layout == 4 /* Pagination */) {
        ...
        break;
      case 3:
        if (this._layout == 1 /* SingleRow */ || this._layout == 2 /* FlowHorizontal */ || this._layout == 4 /* Pagination */) {
          index++;
  ...
  setSelectionOnEvent(item, evt) {
    if (!(item instanceof GButton) || this._selectionMode == 3 /* None */)
      return;
    ...
    if (this._selectionMode == 0 /* Single */) {
      ...
      } else if (evt.isCtrlDown || this._selectionMode == 2 /* Multiple_SingleClick */) {
  ...
  getSnappingPosition(xValue, yValue, resultPoint) {
    if (this._virtual) {
      resultPoint = resultPoint || new Vec215();
      var saved;
      var index;
      if (this._layout == 0 /* SingleColumn */ || this._layout == 2 /* FlowHorizontal */) {
        saved = yValue;
      ...
      } else if (this._layout == 1 /* SingleRow */ || this._layout == 3 /* FlowVertical */) {
        saved = xValue;
        s_n = xValue;
  ...
  scrollToView(index, ani, setFirst) {
    if (this._virtual) {
      ...
      if (this._layout == 0 /* SingleColumn */ || this._layout == 2 /* FlowHorizontal */) {
        ...
        rect = new Rect5(0, pos, this._itemSize.width, ii.height);
      } else if (this._layout == 1 /* SingleRow */ || this._layout == 3 /* FlowVertical */) {
        for (i = this._curLineItemCount - 1; i < index; i += this._curLineItemCount)
          pos += this._virtualItems[i].width + this._columnGap;
        rect = new Rect5(pos, 0, ii.width, this._itemSize.height);
      } else {
  ...
  _refreshVirtualList(dt) {
    ...
    if (layoutChanged) {
      if (this._layout == 0 /* SingleColumn */ || this._layout == 1 /* SingleRow */)
  ...
  handleScroll1(forceUpdate) {
    ...
    while (curIndex < this._realNumItems && (end || curY < max)) {
      ...
      if (needRender) {
        if (this._autoResizeItem && (this._layout == 0 /* SingleColumn */ || this._columnCount > 0))
  ...
  handleScroll2(forceUpdate) {
    ...
    while (curIndex < this._realNumItems && (end || curX < max)) {
      ...
      if (!ii.obj) {
        ...
        needRender = forceUpdate;
      if (needRender) {
        if (this._autoResizeItem && (this._layout == 1 /* SingleRow */ || this._lineCount > 0))
...
var GComboBox = class extends GComponent {
  ...
  constructExtension(buffer) {
    ...
    if (str) {
      ...
      this._list.addRelation(this.dropdown, 14 /* Width */);
      this._list.removeRelation(this.dropdown, 15 /* Height */);
      this.dropdown.addRelation(this._list, 15 /* Height */);
      this.dropdown.removeRelation(this._list, 14 /* Width */);
  ...
  onTouchBegin_1(evt) {
    if (evt.button != EventMouse3.BUTTON_LEFT)
      return;
...
// src/fairygui/GSlider.ts
import { math as math4, Vec2 as Vec216 } from "cc";
var GSlider = class extends GComponent {
  ...
  updateWithPercent(percent, manual) {
    percent = math4.clamp01(percent);
    if (manual) {
      var newValue = math4.clamp(this._min + (this._max - this._min) * percent, this._min, this._max);
      if (this._wholeNumbers) {
        newValue = Math.round(newValue);
        percent = math4.clamp01((newValue - this._min) / (this._max - this._min));
      }
  ...
  onGripTouchBegin(evt) {
    ...
    this._clickPercent = math4.clamp01((this._value - this._min) / (this._max - this._min));
  }
  onGripTouchMove(evt) {
    if (!this.canDrag) {
      return;
    }
    var pt = this.globalToLocal(evt.pos.x, evt.pos.y, s_vec25);
  ...
  onBarTouchBegin(evt) {
    if (!this.changeOnClick)
      return;
    var pt = this._gripObject.globalToLocal(evt.pos.x, evt.pos.y, s_vec25);
    var percent = math4.clamp01((this._value - this._min) / (this._max - this._min));
    var delta = 0;
...
var s_vec25 = new Vec216();

// src/fairygui/GProgressBar.ts
import { math as math5 } from "cc";
var GProgressBar = class extends GComponent {
  ...
  tweenValue(value, duration) {
    ...
    this._value = value;
    return GTween.to(oldValule, this._value, duration).setTarget(this, this.update).setEase(0 /* Linear */);
  }
  update(newValue) {
    var percent = math5.clamp01((newValue - this._min) / (this._max - this._min));
    if (this._titleObject) {
      switch (this._titleType) {
        case 0 /* Percent */:
          this._titleObject.text = Math.floor(percent * 100) + "%";
    ...
    if (this._aniObject)
      this._aniObject.setProp(5 /* Frame */, Math.floor(percent * 100));
  }
  setFillAmount(bar, percent) {
    if ((bar instanceof GImage || bar instanceof GLoader) && bar.fillMethod != 0 /* None */) {
...
// src/fairygui/GScrollBar.ts
import { Vec2 as Vec217 } from "cc";
var GScrollBar = class extends GComponent {
  constructor() {
    super();
    this._node.name = "GScrollBar";
    this._dragOffset = new Vec217();
    this._scrollPerc = 0;
  }
  ...
  onGripTouchMove(evt) {
    if (!this.onStage)
      return;
    var pt = this.globalToLocal(evt.pos.x, evt.pos.y, s_vec26);
    if (this._vertical) {
  ...
  onBarTouchBegin(evt) {
    evt.propagationStopped = true;
    var pt = this._grip.globalToLocal(evt.pos.x, evt.pos.y, s_vec26);
    if (this._vertical) {
      if (pt.y < 0)
...
var s_vec26 = new Vec217();

// src/fairygui/GTreeNode.ts
var GTreeNode = class {
...
// src/fairygui/UIObjectFactory.ts
var _UIObjectFactory = class _UIObjectFactory {
  constructor() {
  }
...
_UIObjectFactory.counter = 0;
_UIObjectFactory.extensions = {};
var UIObjectFactory = _UIObjectFactory;
Decls2.UIObjectFactory = UIObjectFactory;

// src/fairygui/DragDropManager.ts
var DragDropManager = class _DragDropManager {
  static get inst() {
    if (!_DragDropManager._inst)
      _DragDropManager._inst = new _DragDropManager();
    return _DragDropManager._inst;
  }
  constructor() {
    ...
    this._agent.align = 1 /* Center */;
    this._agent.verticalAlign = 1 /* Middle */;
...
// src/fairygui/AsyncOperation.ts
import { Component as Component4, game as game4, Node as Node13 } from "cc";
var AsyncOperation = class {
  ...
  internalCreateObject(item) {
    this._node = new Node13("[AsyncCreating:" + item.name + "]");
    game4.addPersistRootNode(this._node);
...
var AsyncOperationRunner = class extends Component4 {
  constructor() {
    super();
  ...
  collectListChildren(buffer) {
    ...
    for (i = 0; i < itemCount; i++) {
      ...
      if (url) {
        ...
        if (pi) {
          di = { pi, type: pi.objectType };
          if (pi.type == 3 /* Component */)
            di.childCount = this.collectComponentChildren(pi);
          this._itemList.push(di);
          listItemCount++;
        }
  ...
  update() {
    ...
    while (this._index < totalItems) {
      ...
      if (di.pi) {
        ...
        this._objectPool.push(obj);
        if (di.type == 10 /* List */ && di.listItemCount > 0) {
      ...
      this._index++;
      if (this._index % 5 == 0 && game4.totalTime / 1e3 - t >= frameTime)
        return;
    }
...
// src/fairygui/display/SmartLoader.ts
import { SpriteFrame as SpriteFrame6, Texture2D as Texture2D3 } from "cc";
  ...
  loadExternal() {
    ...
    this.__resRequest = Res.create(
      ...
      (err) => {
        ...
        if (ref.content instanceof Texture2D3) {
          this.__spriteFrame = new SpriteFrame6();
