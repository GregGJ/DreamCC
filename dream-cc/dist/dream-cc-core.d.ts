...
declare class Event implements IPoolable {
   ...
   * @param progress
   */
  init(type: EventType, taraget: IEventDispatcher, data?: any, err?: Error, progress?: number): void;
  reset(): void;
  destroy(): boolean;
  release(): void;
  /**
...
declare class SocketManager {
   ...
   * sokcet事件类型枚举
   */
  static EventType: typeof EventType$1;
...
//#endregion
export { ArrayProperty, ArrayValue, AudioManager, BaseConfigAccessor, BaseValue, Binder, BinderUtils, BitFlag, CCLoader, ChangedData, ClassUtils, ConfigManager, ConfigStorage, Dictionary, DictionaryProperty, DictionaryValue, Engine, Event, EventDispatcher, type EventType, Func, FuncNode, FunctionHook, Handler, Http, I18N, type IAudioChannel, type IAudioGroup, type IAudioManager, type IConfigAccessor, type IConfigManager, IDConfigAccessor, type IDeserialization, type IDestroyable, type IEnginePlugin, type IEventDispatcher, type IFuncConfig, type IFuncData, type ILoader, type ILoaderManager, type ILogger, type IPoolable, type IProtocol, type IRedPointData, type IRes, type IResource, type IResourceManager, type ISerDesProperty, type ISerDesValue, type ISerialization, type ISocket, type ISocketManager, type ITask, type ITicker, type ITickerManager, type ITimer, Injector, JSONDeserialization, JSONSerialization, List, LoaderManager, LocalConfigLoader, Logger, MathUtils, Module, ModuleManager, NumberProperty, NumberValue, ObjectUtils, Pool, PropertyBinder, RedPoint, RedPointNode, RemoteConfigLoader, Res, ResRef, ResRequest, type ResURL, Resource, ResourceManager, SerDes, SerDesMode, Socket, SocketManager, SocketManagerImpl, StringProperty, StringUtils, StringValue, Task, TaskQueue, TaskSequence, TickerManager, Timer };
