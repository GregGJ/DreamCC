...
declare class Engine {
     ...
     * @param cb
     */
    static setup(datas: Array<{
        plugin: new () => IEnginePlugin;
        data: any[];
    }>, progress: (v: number) => void, cb: (err: Error | null) => void): void;
    /**
     * 通过类型获取模块
     * @param type
     * @returns
...
export { AudioManager, Binder, BitFlag, CCLoader, ClassUtils, Dictionary, Engine, Event, EventDispatcher, EventType$1 as EventType, Func, FuncNode, FunctionHook, Handler, Http, I18N, IAudioChannel, IAudioGroup, IAudioManager, IDestroyable, IEnginePlugin, IEventDispatcher, IFuncConfig, IFuncData, ILoader, ILoaderManager, ILogger, IPoolable, IProtocol, IRedPointData, IRes, IResource, IResourceManager, ISocket, ISocketManager, ITask, ITicker, ITickerManager, ITimer, Injector, List, LoaderManager, Logger, MathUtils, Module, ModuleManager, ObjectUtils, Pool, PropertyBinder, RedPoint, RedPointNode, Res, ResRef, ResRequest, ResURL, Resource, ResourceManager, Socket, SocketManager, SocketManagerImpl, StringUtils, Task, TaskQueue, TaskSequence, TickerManager, Timer };
